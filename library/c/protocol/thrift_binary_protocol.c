...
int32_t thrift_binary_protocol_read_byte(ThriftProtocol *, int8_t *, int *);
int32_t thrift_binary_protocol_read_i16(ThriftProtocol *, int16_t *, int *);
int32_t thrift_binary_protocol_read_i32(ThriftProtocol *, int32_t *, int *);
int32_t thrift_binary_protocol_read_string(ThriftProtocol *, char **, int *);
                                     ...
                                     const ipaddr_t *value, int *error)
{
  ...
  {
    if ((ret = thrift_binary_protocol_write_byte (protocol, AF_INET, error)) < 0)
    {
      return -1;
    }
    xfer += ret;
    ...
    if ((ret = thrift_binary_protocol_write_byte (protocol, AF_INET6, error)) < 0)
    {
      return -1;
    }
    xfer += ret;
                                         ...
                                         int *error)
{
  ...
  if ((ret = thrift_binary_protocol_read_byte (protocol, &type, error)) < 0)
  {
    return -1;
  }
  xfer += ret;
  *field_type = (ThriftType) type;
  ...
  if ((ret = thrift_binary_protocol_read_i16 (protocol, field_id, error)) < 0)
  {
    return -1;
  }
  xfer += ret;
                                        ...
                                        u_int32_t *size, int *error)
{
  ...
  if ((ret = thrift_binary_protocol_read_byte (protocol, &e, error)) < 0)
  {
    return -1;
  }
  xfer += ret;
                                    ...
                                    int *error)
{
  ...
  if ((ret = thrift_binary_protocol_read_byte (protocol, (int8_t *) &value->iptype,
                                        error)) < 0)
  {
    return -1;
  }
                                    ...
                                    char **str, int *error)
{
  ...
  if ((ret =
       thrift_binary_protocol_read_i32 (protocol, &read_len, error)) < 0)
  {
    return -1;
  }
  xfer += ret;
